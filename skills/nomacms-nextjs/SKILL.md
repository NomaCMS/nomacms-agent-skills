...
export function createBrowserClient() {
  return createClient({
    ...
    projectUserAuth: {
      autoRefresh: true,
      tokenStorage: localStorageAdapter, // see nomacms-sdk-setup
    },
  });
}
```
...
- Noma MCP + schema-first pages (any framework): `nomacms-mcp-content-structure`
- SDK setup and auth context: `nomacms-sdk-setup` and `nomacms-user-auth`
- Filtering and operators: `nomacms-content`
- Error patterns: `nomacms-errors`
